...
> = {
  ...
  laboratorio: {
    ...
    funnel: [
      ...
      { label: "Resultado validado", value: "Fuente no conectada", conversion: "No disponible", note: "requiere LIS/API", status: "not-connected" },
      { label: "Entregado", value: "Fuente no conectada", conversion: "No disponible", note: "timestamps pendientes", status: "not-connected" },
    ...
    blocks: [
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Ordenes sin resultado", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
          ...
          { label: "Validacion a entrega", value: "Fuente no conectada", note: "timestamp requerido", status: "not-connected" },
        ],
      },
    ],
  },
    ...
    blocks: [
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Tiempo de informe", value: "Fuente no conectada", note: "requiere RIS/PACS", status: "not-connected" },
