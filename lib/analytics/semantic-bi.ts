...
export const semanticKpiContracts = [
  ...
  },
  {
    ...
    executiveDefinition: "Uso tecnico de analizadores, estaciones o throughput de laboratorio.",
    exclusionRules: [
  ...
  },
  {
    ...
    source: "DEMO semantic-bi; Sprint 3 debe reemplazar por resultados de validacion server-side.",
    supportedDimensions: [...semanticSupportedDimensions],
    supportedFilters: [...semanticSupportedFilters],
...
function buildLaboratoryLineFromTemplates(
  ...
  return {
    ...
    capacity: {
      ...
      noShowRate: null,
      pendingMessage: "Laboratorio usa utilizacion tecnica y throughput, no ocupacion clinica.",
      scheduled: 0.84,
