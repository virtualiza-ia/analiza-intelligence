...
> = {
  ...
  laboratorio: {
    ...
    primaryMetrics: [
      ...
      { label: "Resultados dentro SLA", value: "Fuente no conectada", note: "requiere LIS/API", status: "not-connected" },
    ],
    trendChart: {
    ...
    blocks: [
      {
        ...
        metrics: [
          ...
          { label: "Capacidad de validacion", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Validacion pendiente", value: "Fuente no conectada", note: "LIS/API", status: "not-connected" },
        ],
      },
    ],
    executiveActions: [
    ...
    blocks: [
      {
        ...
        metrics: [
          ...
          { label: "Capacidad de lectura", value: "Fuente no conectada", note: "radiologos/RIS", status: "not-connected" },
