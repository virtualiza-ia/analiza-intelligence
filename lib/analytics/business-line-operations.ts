...
export const businessLineViews: Record<BusinessLineSlug, LineViewDefinition> = {
  ...
  laboratorio: {
    ...
    funnel: [
      ...
      { label: "Resultado validado", value: "Fuente no conectada", conversion: null, status: "NOT_CONNECTED" },
      { label: "Resultado entregado", value: "Fuente no conectada", conversion: null, status: "NOT_CONNECTED" },
    ...
    appointmentMetrics: [
      ...
      { label: "Ordenes sin resultado", value: "Fuente no conectada", note: "requiere LIS/API", status: "NOT_CONNECTED" },
    ],
    ...
    capacityMetrics: [
      ...
      { label: "Cola de muestras", value: "Fuente no conectada", note: "requiere LIS", status: "NOT_CONNECTED" },
  ...
  imagenes: {
    ...
    appointmentMetrics: [
      ...
      { label: "Demanda por modalidad", value: "Fuente no conectada", note: "requiere RIS/PACS", status: "NOT_CONNECTED" },
    ],
    ...
    capacityMetrics: [
      ...
      { label: "Mantenimiento", value: "Fuente no conectada", note: "pendiente API/equipo", status: "NOT_CONNECTED" },
    ],
