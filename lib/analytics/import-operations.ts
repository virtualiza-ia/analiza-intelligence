...
export const manualMonthlyFormSteps: ManualMonthlyFormStep[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        id: "lab_no_doctor_patient_sales",
        label: "Venta por pacientes sin medico",
        description: "Monto vendido a pacientes sin medico referido.",
        inputType: "currency",
        unit: "USD",
        required: true,
        placeholder: "0.00",
      ...
      {
        id: "lab_no_doctor_order_count",
        label: "Numero de ordenes sin medico",
        description: "Cantidad de ordenes sin medico referido.",
        inputType: "number",
        unit: "ordenes",
        required: true,
        placeholder: "0",
