    ...
    blocks: [
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Pruebas repetidas", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
          { label: "Resultados corregidos", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
          { label: "Resultados pendientes", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
        ],
      },
      {
        ...
        metrics: [
          { label: "Tiempo promedio de entrega", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
          { label: "Mediana de entrega", value: "Fuente no conectada", note: "requiere timestamps", status: "not-connected" },
          { label: "Porcentaje dentro del tiempo prometido", value: "Pendiente", note: "requiere SLA por prueba", status: "pending-upload" },
          { label: "Resultados fuera de plazo", value: "Fuente no conectada", note: "requiere validacion", status: "not-connected" },
          ...
          { label: "Valores criticos pendientes de notificacion", value: "Fuente no conectada", note: "requiere LIS/alertas", status: "not-connected" },
        ],
      },
      {
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Pruebas por analizador", value: "Fuente no conectada", note: "requiere equipo/LIS", status: "not-connected" },
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Equipos fuera de servicio", value: "Fuente no conectada", note: "mantenimiento/equipo", status: "not-connected" },
          { label: "Cola de muestras", value: "Fuente no conectada", note: "requiere LIS", status: "not-connected" },
          { label: "Saturacion por area", value: "Pendiente de carga", note: "area tecnica requerida", status: "pending-upload" },
          { label: "Tiempo de inactividad", value: "Fuente no conectada", note: "requiere eventos equipo", status: "not-connected" },
    ...
    blocks: [
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Estudios por equipo", value: "Fuente no conectada", note: "requiere RIS/PACS", status: "not-connected" },
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Tiempo promedio de informe", value: "Fuente no conectada", note: "requiere RIS/PACS", status: "not-connected" },
          { label: "Porcentaje dentro del tiempo prometido", value: "Pendiente", note: "requiere SLA por modalidad", status: "pending-upload" },
          { label: "Informes atrasados", value: "Fuente no conectada", note: "requiere timestamps", status: "not-connected" },
        ],
      },
      {
        title: "D. Equipos",
        ...
        metrics: [
          ...
          { label: "Tiempo fuera de servicio", value: "Fuente no conectada", note: "requiere mantenimiento", status: "not-connected" },
          { label: "Mantenimiento preventivo", value: "Fuente no conectada", note: "requiere equipo", status: "not-connected" },
          { label: "Mantenimiento correctivo", value: "Fuente no conectada", note: "requiere equipo", status: "not-connected" },
      ...
      },
      {
        ...
        metrics: [
          ...
          { label: "Eventos operativos", value: "Fuente no conectada", note: "registro de eventos", status: "not-connected" },
          { label: "Quejas", value: "Fuente no conectada", note: "experiencia paciente", status: "not-connected" },
      ...
      },
      {
        ...
        metrics: [
          { label: "Estudios por tecnico", value: "86", note: "mensual DEMO", status: "available" },
          { label: "Informes por radiologo", value: "Fuente no conectada", note: "requiere medico informante", status: "not-connected" },
