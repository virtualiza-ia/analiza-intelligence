...
export function LaboratoryVerticalDashboard({
  ...
  const formContextItems: ClosureContextItem[] = [
    {
      ...
      value: selectedBranchScope?.branchName
        ? `${selectedBranchScope.branchName} · Laboratorio`
        : "Sucursal autorizada · Laboratorio",
    },
    {
      label: "Pais",
    ...
    },
    {
      ...
      value: selectedBranchScope?.companyName ?? "Analiza Laboratorio",
    },
    {
  ...
  function renderWizardStep() {
        ...
        children: (
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            {[
              ...
              <div className="grid gap-2 rounded-md border bg-muted/20 p-3 text-sm" key={label}>
    ...
    if (activeStep === 3) {
      return renderStepSection({
        description: "Desglose por origen para validar consistencia comercial.",
        title: "Origen de venta",
        children: renderNumberFields(originFields),
      });
    }
