...
import type {
  ...
  ImagingClosure,
  ImagingClosureInputs,
  ImagingInsight,
  ImagingKpiResult,
  ImagingTarget,
  ImagingTargetComparison,
  ImagingTargetDirection,
...
type ImagingVerticalDashboardProps = {
  embedded?: boolean;
  mode: DashboardMode;
};
...
type ClosureInputKey = keyof ImagingClosureInputs;
...
const productionFields: FieldConfig[] = [
  ...
  {
    description: "Clientes nuevos del periodo cuando la plantilla lo soporte.",
    key: "newClients",
  ...
  {
    description: "Estudios agendados. Campo operativo propuesto desde agenda.",
    key: "scheduledStudies",
    label: "Estudios agendados",
    source: "NUEVO PROPUESTO",
    unit: "estudios",
  },
  {
    description: "Estudios cancelados si existe fuente de agenda.",
    key: "cancelledStudies",
    label: "Cancelados",
    source: "NUEVO PROPUESTO",
    unit: "estudios",
  },
  {
    description: "No-show si existe fuente de agenda.",
    key: "noShowStudies",
    label: "No-show",
    source: "NUEVO PROPUESTO",
    unit: "estudios",
...
const financeFields: FieldConfig[] = [
  ...
  {
    description: "Pacientes de telemedicina segun plantilla.",
    key: "telemedicinePatients",
    label: "Telemedicina pacientes",
    source: "MANUAL",
    unit: "personas",
  },
  {
    description: "Facturacion atribuida a telemedicina segun plantilla.",
    key: "telemedicineRevenue",
    label: "Telemedicina venta",
    source: "MANUAL",
    unit: "USD",
  },
];
...
const modalityFields: FieldConfig[] = [
  {
    ...
    key: "xrayStudies",
    label: "Rayos X estudios",
    source: "MANUAL",
    unit: "estudios",
  },
  {
    description: "Venta de Rayos X.",
    key: "xrayRevenue",
    label: "Rayos X venta",
    source: "MANUAL",
    unit: "USD",
  ...
  {
    description: "Estudios de Ultrasonografia.",
    key: "ultrasoundStudies",
    label: "Ultrasonografia estudios",
    source: "MANUAL",
    unit: "estudios",
  },
  {
    description: "Venta de Ultrasonografia.",
    key: "ultrasoundRevenue",
    label: "Ultrasonografia venta",
    source: "MANUAL",
    unit: "USD",
  },
  {
    description: "Estudios Doppler.",
    key: "dopplerStudies",
    label: "Doppler estudios",
    source: "MANUAL",
    unit: "estudios",
  },
  {
    description: "Venta Doppler.",
    key: "dopplerRevenue",
    label: "Doppler venta",
    source: "MANUAL",
    unit: "USD",
  ...
  {
    description: "Cantidad de placas extras.",
    key: "extraPlatesCount",
    label: "Placas extras",
    source: "MANUAL",
    unit: "estudios",
  },
  {
    description: "Venta de placas extras.",
    key: "extraPlatesRevenue",
    label: "Placas extras venta",
    source: "MANUAL",
    unit: "USD",
  },
];
...
const capacityFields: FieldConfig[] = [
  {
    description: "Tecnicos licenciados activos durante el periodo.",
    key: "licensedStaffCount",
    label: "Licenciados",
    source: "MANUAL",
    unit: "personas",
  },
  ...
  {
    description: "Radiologos o medicos activos.",
    key: "doctorStaffCount",
    label: "Medicos",
    source: "MANUAL",
    unit: "personas",
  },
  {
    description: "Personal de entrega activo.",
    key: "deliveryStaffCount",
    label: "Entrega",
    source: "MANUAL",
    unit: "personas",
  },
  {
    description: "Personal de limpieza activo.",
  ...
  {
    description: "Horas disponibles de equipos en el periodo.",
    key: "equipmentAvailableHours",
    label: "Horas disponibles",
    source: "NUEVO PROPUESTO",
    unit: "horas",
  },
  {
    description: "Horas utilizadas de equipos.",
    key: "equipmentUsedHours",
    label: "Horas utilizadas",
    source: "NUEVO PROPUESTO",
    unit: "horas",
  },
  {
    description: "Horas fuera de servicio.",
    key: "equipmentDowntimeHours",
...
const qualityFields: FieldConfig[] = [
  {
    description: "Informes o lecturas firmadas.",
    key: "reportReadingCount",
    label: "Lecturas firmadas",
    source: "MANUAL",
    unit: "informes",
  },
  {
    description: "Informes pendientes si existe fuente PACS/RIS.",
    key: "pendingReports",
  ...
  {
    description: "Tiempo promedio de orden a realizacion.",
    key: "averageOrderToStudyHours",
    label: "Orden a realizacion",
    source: "NUEVO PROPUESTO",
    unit: "horas",
  },
  {
    description: "Tiempo promedio de realizacion a informe.",
    key: "averageReportTatHours",
    label: "TAT informe",
    source: "NUEVO PROPUESTO",
    unit: "horas",
  },
...
const targetKpiOptions: Array<{
  ...
  kpiId: ImagingTargetableKpiId;
  label: string;
  unit: "USD" | "estudios" | "informes" | "horas" | "%";
}> = [
  {
  ...
  },
  {
    ...
    label: "Utilizacion minima",
    unit: "%",
  },
];

const kpiFieldLabels: Record<string, string> = {
  averageOrderToStudyHours: "TAT orden a realizacion",
  averageReportTatHours: "TAT informe",
  cancelledStudies: "estudios cancelados",
  clientsTotal: "clientes",
  costOfSales: "costo de ventas",
  equipmentAvailableHours: "horas disponibles de equipo",
  equipmentDowntimeHours: "horas de equipo detenido",
  equipmentUsedHours: "horas utilizadas de equipo",
  modalidad_estudios: "estudios por modalidad",
  modalityCapacityHours: "capacidad por modalidad",
  noShowStudies: "no-show",
  ordersTotal: "ordenes",
  pendingReports: "informes pendientes",
  revenueTotal: "facturacion neta",
  scheduledStudies: "estudios agendados",
...
function targetStatusLabel(status: ImagingTarget["status"]) {
  return status === "active" ? "Activa" : "Inactiva";
}

function priorityClass(priority: ImagingInsight["priority"]) {
  if (priority === "critica") {
    return "bg-red-100 text-red-800 hover:bg-red-100";
  }
...
function formValuesFromClosure(closure: ImagingClosure): ClosureFormValues {
  return {
...
function emptyFormValues(workspace: ImagingWorkspace): ClosureFormValues {
  return {
...
function selectedBranch(
  workspace: ImagingWorkspace | null,
...
function KpiGrid({ kpis }: { kpis: ImagingKpiResult[] }) {
  const [openKpiId, setOpenKpiId] = useState<ImagingKpiResult["id"] | null>(
    null,
  );
  ...
  return (
    <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
      {kpis.map((kpi) => {
        ...
        const infoId = `imagenes-kpi-info-${kpi.id}`;
        ...
        <table className="w-full min-w-[980px] text-left text-sm">
          <thead className="text-xs text-muted-foreground">
            <tr className="border-b">
              ...
              <th className="py-2 pr-4 font-medium">Cumplimiento</th>
              <th className="py-2 pr-4 font-medium">Estudios</th>
          ...
          <tbody>
            {rows.map((row) => (
              <tr className="border-b last:border-b-0" key={row.closureId}>
                ...
                <td className="py-3 pr-4">{formatCount(row.studies)}</td>
...
function InsightsList({ insights }: { insights: ImagingInsight[] }) {
  return (
...
function ValidationPanel({ closure }: { closure: ImagingClosure | null }) {
  if (!closure) {
    return (
...
function Header({
  ...
  const titleByMode: Record<DashboardMode, string> = {
    "branch-home": "Mi sucursal Imagenes",
    history: "Historial de cierres Imagenes",
    ...
    <div className="grid gap-4 xl:grid-cols-[1fr_320px] xl:items-end">
      <div className="grid gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline">Imagenes end-to-end</Badge>
...
export function ImagingVerticalDashboard({
  embedded = false,
  mode,
}: ImagingVerticalDashboardProps) {
  const [workspace, setWorkspace] = useState<ImagingWorkspace | null>(null);
  ...
  const [workingClosure, setWorkingClosure] =
    useState<ImagingClosure | null>(null);
  ...
  async function refreshWorkspace() {
    ...
    try {
      const response = await fetch("/api/imaging/closures", {
        cache: "no-store",
      });
  ...
  async function validateDraft() {
    ...
    const response = await fetch(
      `/api/imaging/closures/${savedClosure.id}/validate`,
      { method: "POST" },
    );
    const payload = await readWorkspaceResponse(response);
  ...
  async function publishDraft() {
    ...
    const response = await fetch(
      `/api/imaging/closures/${savedClosure.id}/publish`,
      { method: "POST" },
    );
    const payload = await readWorkspaceResponse(response);
  ...
  async function saveTarget() {
    ...
    const response = await fetch("/api/imaging/targets", {
      body: JSON.stringify({
        ...targetFormValues,
  ...
  function startCorrection(closure: ImagingClosure) {
    setFormValues({
      branchId: closure.scope.branchId ?? "",
      id: "",
      inputs: Object.fromEntries(
  ...
  const summaryCards = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        value: formatCount(summary?.studies),
      },
      {
        label: "Productividad",
        note: "Estudios / personal",
    ...
    <section className={sectionClass}>
      ...
      {showHome ? (
        <section className="grid gap-4 xl:grid-cols-[1fr_340px]">
          ...
          <aside className="grid gap-3 rounded-md border bg-card p-4">
            ...
            <Button asChild>
              <Link href="/protected/cierres/nuevo">
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      setTargetFormValues({
                        ...
                        kpiId:
                          (event.target.value as ImagingTargetableKpiId) ??
      ...
      <section className="rounded-md border bg-card p-4">
        ...
        <div className="grid gap-3 text-sm leading-6 text-muted-foreground md:grid-cols-3">
          <span>
            Input: cierre mensual de Imagenes con campos fuente manuales y
...
export function ImagingExecutiveSummary() {
  return <ImagingVerticalDashboard embedded mode="overview" />;
}
