...
| #4 | Integrate functional base with PR #2 and PR #3 | Alberto / Primary Codex | `codex/alberto/integracion-final` | auth, RBAC, invitations, branches, manual forms, database contracts, dependencies, environment contracts | In progress |
