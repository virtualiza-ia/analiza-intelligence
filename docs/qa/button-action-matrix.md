...
| Sidebar desktop | Gerente Sucursal | Links permitidos | Muestra mi sucursal, formulario mensual, cierres, resultados y mi cuenta; Importaciones, Conectores, metas, insights y bonos quedan bloqueados como pantallas separadas | Validado por tests navigation/RBAC | PASS | - |
...
| Formulario mensual `/protected/plantillas` | Gerente Sucursal | Capturar cierre por linea | Usa solo la sucursal o sucursales asignadas al usuario y alimenta KPIs del cierre oficial | Cubierto por vertical/RBAC tests | PASS | - |
...
| Importaciones `/protected/importaciones` | Admin, Operaciones, Area | Descargar plantilla, subir, validar, publicar, rollback, reemplazar, lineage, fallback | Respeta permisos y audita flujo sin mezclar produccion; Gerente Sucursal queda bloqueado y usa Formulario mensual | Cubierto por ingestion/connectors tests | PASS | - |
