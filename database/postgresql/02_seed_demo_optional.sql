-- Analiza Intelligence optional DEMO seed
-- Generated from supabase/seed.sql on 2026-08-03.
-- DEMO data only. Do not load into a real production organization unless intentionally testing.
